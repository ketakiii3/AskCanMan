...
'''@app.route("/restaurant_chatbot.html")
def restaurant_chatbot():
    # Render the restaurant_chatbot.html template
    return render_template("restaurant_chatbot.html")

# Modify the redirectToChatbot() function to redirect to the chatbot page
def redirectToChatbot():
    # Redirect to the restaurant_chatbot.html page
    return redirect(url_for("restaurant_chatbot"))'''
